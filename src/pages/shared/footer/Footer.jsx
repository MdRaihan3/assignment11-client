    ...
    return (
        <div>
            <footer className=" p-10 bg-neutral text-neutral-content">
                <div className=" footer">
                    ...
                    <div>
                       <h1 className="footer-title">Contact Us: dsfasadjlkfjasd</h1> 
                        ...
                        <hr />
                        <p><span className=" font-bold">Phone No: </span> +8801829111205</p>
                        <hr />
                        <p><span className=" font-bold">Office: </span>Kadamtali, Gulistan, Dhaka </p>
                    </div>
                    <nav>
                ...
                <p className=" text-center mt-12">Copyright © 2024 - All right reserved by RFood</p>
            </footer>
        </div>
    );
};
